...
4. Place your model file (`.h5` - make sure to take the 'best.h5' and not the 'last.h5') and classes list (`.yaml`) inside your model folder. Always make sure you have a backup - just in case. If you ever need to update EcoAssist, it will remove the entire folder and you'll have to do this again. 
