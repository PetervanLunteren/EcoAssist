@REM ### Windows install commands for the EcoAssist application v4.0 https://github.com/PetervanLunteren/EcoAssist
@REM ### Peter van Lunteren, 18 Dec 2023
...
if exist "%LOCATION_ECOASSIST_FILES%\EcoAssist\" (
    ...
    cd "%LOCATION_ECOASSIST_FILES%\EcoAssist" || ( echo "Could not change directory to cameratraps. Command could not be run. Installation was terminated. Copy-paste this output and send it to petervanlunteren@hotmail.com for further support." | wtee -a "%LOG_FILE%" & cmd /k & exit )
    "%EA_GIT_EXE%" checkout 3b5442db389c99c080cd186b4ed2327be5c2d64c
    cd "%LOCATION_ECOASSIST_FILES%" || ( echo "Could not change directory to EcoAssist_files. Command could not be run. Installation was terminated. Copy-paste this output and send it to petervanlunteren@hotmail.com for further support." | wtee -a "%LOG_FILE%" & cmd /k & exit )
