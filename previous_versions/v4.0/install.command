...
### OSx and Linux install commands for the EcoAssist application v4.0 https://github.com/PetervanLunteren/EcoAssist
### Peter van Lunteren, 18 Dec 2023
...
if [ -d "$ECO" ]; then
  ...
  cd $LOCATION_ECOASSIST_FILES/EcoAssist || { echo "Could not change directory. Command could not be run. Please send an email to petervanlunteren@hotmail.com for assistance." 2>&1 | tee -a "$LOG_FILE"; exit 1; }
  git checkout 3b5442db389c99c080cd186b4ed2327be5c2d64c 2>&1 | tee -a "$LOG_FILE"
